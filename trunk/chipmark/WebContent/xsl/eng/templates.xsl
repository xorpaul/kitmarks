...
<xsl:stylesheet version="1.0"
				...
				<table width="100%" border="0">
					<tr>
						<td valign="top" width="50%">
							<p class="sub_header">Your tasks</p>
	...
	<xsl:template name="BODY_ACCOUNT_PREFS">
		...
		<table width="60%" border="0" cellspacing="1" cellpadding="1">
			<tr>
				<td>
					<p class="body">
						You may change your account information below. To do so, you must
						type in your current password for all changes to go into effect.
						<form action="AccountPreferences" method="POST">
							<table width="100%" border="0">
								<tr>
									<td class="form_elements">new e-mail address:</td>
									<td>
								...
								<tr>
									<td class="form_elements">new password:</td>
									<td>
										<xsl:element name="input">
								...
								<tr>
									<td class="form_elements">confirm password:</td>
									<td>
										<xsl:element name="input">
											<xsl:attribute name="type">PASSWORD</xsl:attribute>
								...
								<tr>
									<td class="form_elements">current password:</td>
									<td>
										<xsl:element name="input">
											<xsl:attribute name="type">PASSWORD</xsl:attribute>
								...
								<tr>
									<td></td>
									<td>
										<INPUT TYPE="SUBMIT" name="submitBtn" VALUE="update preferences" />
										<BR />
									</td>
								</tr>
							</table>
	...
	<xsl:template name="BODY_ADD_CLIENT">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					<p class="body">
						Creating a new account will let you access your bookmarks
						anywhere. Please read our
					...
					<form name="register_form" method="post" action="AddClient">
						<table border="0" cellpadding="0" cellspacing="5">
							<tr>
								...
								<td class="form_elements" align="left" valign="top">required
									information</td>
							</tr>
							<tr>
							...
							<tr>
								<td width="150"></td>
								<td width="150">
									<p class="form_login_always"> In case you forget your password at a later date,
										please enter a valid email address so we can send it to you.
									</p>
								</td>
							</tr>
							<tr>
	...
	<xsl:template name="BODY_ADD_CLIENT_RESULT">
		...
		<xsl:if test="xml/Result = 'SUCCESS'">
			<p>
				<font color="green">Account successfully created. You may now
					log in to your account.</font>
			</p>
		</xsl:if>
		<xsl:if test="xml/Result != 'SUCCESS'">
			<p>
	...
	<xsl:template name="BODY_FAQS">
		...
		<table border="0" cellspacing="10" cellpadding="0" align="center"
			...
			<tr valign="top">
				...
				<td>
					<a name="Q1">
						<p class="sub_header">What is Chipmark?</p>
					</a>
					<p> Chipmark is an online bookmark manager that allows you to
						access your bookmarks from any computer, anywhere.</p>
				</td>
			</tr>
			<tr valign="top">
				<td>
	...
	<xsl:template name="BODY_FORGOTTEN_USERNAME_PASSWORD">
		<xsl:choose>
			<xsl:when test="xml/Result = 'SUCCESS'">
				<p>
					<font color="green">The user information you have requested has
						been sent to your email.</font>
				</p>
			</xsl:when>
			<xsl:otherwise>
				<p>
				...
				<p class="title">forgot your username or password?</p>
				<p class="body"> Enter your email address you used when you signed up for
					a chipmark account.</p>
				<p class="body">
					You can also
					<a href="/Main?target=registration">register a new account</a>
						...
						<tr>
							...
							<td class="form_elements" align="left" valign="top">
								<input name="submitBtn" type="submit" id="get_password"
									value="retrieve user information" />
							</td>
						</tr>
					</table>
				</form>
			...
			<table border="0" width="125" cellpadding="0" cellspacing="0">
				<tr>
					<td>
						...
						<span style="font-size:10px;color:#AAAAAA">remember me</span>
						<br />
						<div align="center">
						...
						<div align="right">
							<a class="copyright" href="Main?target=registration">register a new account</a>
							<br />
							<a class="copyright" href="Main?target=forgottenusernamepassword">forgot your username or
								password?</a>
						</div>
					</td>
				</tr>
	...
	<xsl:template name="BODY_MAIN">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td valign="top">
					<p class="sub_header">Welcome to the chipmark prototype installation!
					</p>
					<p class="content">
						User with an FZKA or IAI domainaccount do
						<font color='red'>
							<b>not</b>
						</font>
						need to register a new account!
						<br />
						They can login by using their normal ADS account information
						<br />
						<br />
						Example:
					...
					<br />
					<br />
					<p class="sub_header">Gerneral note:</p>
					<p class="content">chipmarks = bookmarks</p>
					<p class="content">
						This is the ALPHA version from the Firefox 3 browserplugin:
						<a href="https://www.chipmark.com/firefox/chipmark-3.3pre1.xpi"
							target="_blank">Download from chipmark.com</a>
						<br />
						This version is the unmodified version provided by the original
						chipmark developers.
						<br />
						Thereby you need to change
						<b>after</b>
						the installation the Chipmark Host entry that can be found under
						<br />
						Extras -> Add-ons -> Chipmark -> settings -> Chipmark
						<br />
						instead of 'https://www.chipmark.com'
						'https://iwrpaul.ka.fzk.de:8433'.
					</p>
				</td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td valign="top" class="front_page" height="30" width="100%"
								...
								<span class="front_title">Why use chipmark?</span>
							</td>
						</tr>
						<tr>
							...
							<xsl:when test="not(boolean(xml/LoggedInAs)) or xml/LoggedInAs = ''">
								<tr>
									<td valign="top" class="front_page" height="30" width="100%"
										...
										<span class="front_title">Register now</span>
										<br />
										<span class="front_sub_title">Everyone can join!</span>
									</td>
								</tr>
							</xsl:when>
							<xsl:otherwise>
